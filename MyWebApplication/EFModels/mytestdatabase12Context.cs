...
{
    public partial class mytestdatabase12Context : DbContext
    {
        public mytestdatabase12Context()
        {
        }

        public mytestdatabase12Context(DbContextOptions<mytestdatabase12Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=tcp:mytest2020.database.windows.net,1433;Initial Catalog=mytestdatabase12;Persist Security Info=False;User ID=jfkelfhe;Password=j@dh4hj@d;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
